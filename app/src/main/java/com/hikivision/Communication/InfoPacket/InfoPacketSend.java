 ...
 *
 * HEAD BYTENUM     INFO
 * 0xA4	0x06	    0xC1	单字节PWM    时间戳(3byte)  CRC(2byte)      0-100%速率左行
 * 	    0x06	    0xC2	单字节PWM	时间戳         CRC             0-100%速率右行
...
public class InfoPacketSend {
    ...
    private static Map<INFO_SEND_KIND,Byte> send_data_map=new HashMap<INFO_SEND_KIND,Byte>(){{
        ...
        put(INFO_SEND_KIND.SET_STOP_BRAKE,       Byte.valueOf((byte) 0xC3));
        put(INFO_SEND_KIND.SET_BAND_BRAKE,       Byte.valueOf((byte) 0xC4));
        put(INFO_SEND_KIND.SET_POWEROFF,         Byte.valueOf((byte) 0xD4));
        put(INFO_SEND_KIND.ASK_ONE_SECOND_HEART, Byte.valueOf((byte) 0xE1));
        put(INFO_SEND_KIND.ASK_GESTURE,          Byte.valueOf((byte) 0xE2));
        put(INFO_SEND_KIND.ASK_FIVE_SECOND_HEART,Byte.valueOf((byte) 0xEB));
    ...
    public enum INFO_SEND_KIND{
        ...
        SET_BAND_BRAKE,
        SET_POWEROFF,
        ASK_ONE_SECOND_HEART,
        ASK_GESTURE,
        ASK_FIVE_SECOND_HEART,
        CANCELL_LIGHT_WARN,
        CANCELL_MOTOR_WARN
    }
}
