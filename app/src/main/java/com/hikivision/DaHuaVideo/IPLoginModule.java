...
public class IPLoginModule {
    private final String TAG = "IPLoginModule";
...
//        mLoginHandle = INetSDK.LoginEx3(pstLoginParam, mDeviceInfo, err);
        ...
        if (0 == mLoginHandle) {
            ...
            Log.e(TAG,"Failed to Login Device " + address + "FinalVar.java 对应的错误码 ：[0x80000000|" + (INetSDK.GetLastError() & 0x7fffffff) + "]" + "\n" +
...
//            ToolKits.writeErrorLog("Failed to Login Device " + address);
        ...
        if(bPlayRet == false)
        {
            Log.d(TAG,"SetLocalMode-EM_LOCAL_PLAY_FLAG_MODE failed,nPlayValue:" + nPlayValue + "LastError:" + INetSDK.GetLastError());
//            ToolKits.writeLog("SetLocalMode-EM_LOCAL_PLAY_FLAG_MODE failed,nPlayValue:" + nPlayValue + "LastError:" + INetSDK.GetLastError());
        ...
        {
            Log.d(TAG,"SetLocalMode-EM_LOCAL_PLAYBACK_FLAG_MODE failed,nPlaybackValue：" + nPlaybackValue + "LastError:" + INetSDK.GetLastError());
